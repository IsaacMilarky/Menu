...
<context>
    ...
    <message>
        ...
        <translation>Об окружении hello</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Переменная среды SUDO_ASKPASS не найдена. Система настроена неправильно.</translation>
    </message>
    <message>
        <location filename="../mainwindow.cpp" line="155"/>
        <source>The UBUNTU_MENUPROXY environment variable is missing. The system is not configured correctly.</source>
        <translation>Переменная среды UBUNTU_MENUPROXY не найдена. Система настроена неправильно.</translation>
    </message>
    <message>
        <location filename="../mainwindow.cpp" line="159"/>
        <source>The UBUNTU_MENUPROXY environment variable is not set to &quot;1&quot;. The system is not configured correctly.</source>
        <translation>Переменная среды UBUNTU_MENUPROXY не установлена в &quot;1&quot;. Система настроена неправильно.</translation>
    </message>
    <message>
        <location filename="../mainwindow.cpp" line="166"/>
        <source>The GTK_MODULES environment variable is missing. The system is not configured correctly.</source>
        <translation>Переменная среды GTK_MODULES не найдена. Система настроена неправильно.</translation>
    </message>
    <message>
        ...
        <translation>Переменная среды GTK_MODULES не содержит &quot;appmenu-gtk-module&quot;. Система настроена неправильно.</translation>
    </message>
    <message>
        <location filename="../mainwindow.cpp" line="180"/>
        <source>The QT_QPA_PLATFORMTHEME environment variable is missing. The system is not configured correctly.</source>
        <translation>Переменная среды QT_QPA_PLATFORMTHEME не найдена. Система настроена неправильно.</translation>
    </message>
    <message>
        ...
        <translation>Переменная среды QT_QPA_PLATFORMTHEME не содержит &quot;panda&quot;. Система настроена неправильно.</translation>
    </message>
    <message>
        <location filename="../mainwindow.cpp" line="194"/>
        <source>The XDG_SESSION_TYPE environment variable is missing. The system is not configured correctly.</source>
        <translation>Переменная среды XDG_SESSION_TYPE не найдена. Система настроена неправильно.</translation>
    </message>
    <message>
        <location filename="../mainwindow.cpp" line="198"/>
        <source>The XDG_SESSION_TYPE environment variable is not set to &quot;x11&quot;. The system is not configured correctly.</source>
        <translation>Переменная среды XDG_SESSION_TYPE не установлена в &quot;x11&quot;. Система настроена неправильно.</translation>
    </message>
    <message>
        <location filename="../mainwindow.cpp" line="218"/>
        <source>Your disk &apos;%1&apos; is almost full. %2 percent left.</source>
        <translation>Ваш диск &apos;%1&apos; почти заполнен. Осталось %2 процентов.</translation>
    </message>
    <message>
        <location filename="../mainwindow.cpp" line="319"/>
        <source>Screen resolution is below the minimum system requirement of 640x480 pixels.</source>
        <translation>Разрешение экрана ниже минимальных системных требований в 640x480 пикселей.</translation>
    </message>
</context>
<context>
